...
public class SSU {
  ...
  public static String setASetStringMember(String setValue, int member,
				    String value) {
    return SSU.setASetStringMember(setValue, member,
					      value.charAt(0));
  }
 ...
 */
   ...
   * @param setS String Set
   * @return Index of the first Y*/
   ...
   * the set member 
   * @return string to be used in a SQL like where clause
   */
  public static String makeSetsLikeMask(int member, String value) {
    return SSU.makeSetsLikeMask(member, value.charAt(0));
  }
