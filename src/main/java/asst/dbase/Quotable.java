...
public class Quotable {
  ...
  /** Check whether a SQL column needs a quoted string
   * @param SQLColumnType SAL standard data type
   * @return true if it needs to be quoted.
   */
 ...
 */
  ...
  /** Prepare a string for use in a SQL insert or update
  ...
  /** Combine 5 different strings into one space-separated string if
