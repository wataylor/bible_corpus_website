...
public class CommandArgs extends Hashtable<String, Object> {
  ...
  /** Constructor which initializes the argument list from an
   * argument array.  Generally used with the default arguments. 
   ...
   * @return list of command line strings*/
   ...
   * @return boolean value of the named command line argument*/
